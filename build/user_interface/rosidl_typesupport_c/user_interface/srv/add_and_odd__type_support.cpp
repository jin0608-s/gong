...
static const _AddAndOdd_Request_type_support_symbol_names_t _AddAndOdd_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_interface, srv, AddAndOdd_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, user_interface, srv, AddAndOdd_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, user_interface, srv, AddAndOdd_Request)() {
  return &::user_interface::srv::rosidl_typesupport_c::AddAndOdd_Request_message_type_support_handle;
}
...
static const _AddAndOdd_Response_type_support_symbol_names_t _AddAndOdd_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_interface, srv, AddAndOdd_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, user_interface, srv, AddAndOdd_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, user_interface, srv, AddAndOdd_Response)() {
  return &::user_interface::srv::rosidl_typesupport_c::AddAndOdd_Response_message_type_support_handle;
}
...
static const _AddAndOdd_Event_type_support_symbol_names_t _AddAndOdd_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_interface, srv, AddAndOdd_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, user_interface, srv, AddAndOdd_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, user_interface, srv, AddAndOdd_Event)() {
  return &::user_interface::srv::rosidl_typesupport_c::AddAndOdd_Event_message_type_support_handle;
}
...
static const _AddAndOdd_type_support_symbol_names_t _AddAndOdd_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, user_interface, srv, AddAndOdd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, user_interface, srv, AddAndOdd)),
  }
};
...
static const rosidl_service_type_support_t AddAndOdd_service_type_support_handle = {
  ...
  &AddAndOdd_Request_message_type_support_handle,
  &AddAndOdd_Response_message_type_support_handle,
  &AddAndOdd_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, user_interface, srv, AddAndOdd)() {
  return &::user_interface::srv::rosidl_typesupport_c::AddAndOdd_service_type_support_handle;
}
